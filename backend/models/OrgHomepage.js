...
const orgHomepageSchema = new mongoose.Schema({
  ...
  certificateTemplate: {
    ...
    orgLogoUrl: { type: String, default: '' },
    logoWidth: { type: Number, default: 120 },
    logoHeight: { type: Number, default: 120 },
    logoPosition: { type: String, enum: ['left', 'center', 'right'], default: 'center' },
    primaryColor: { type: String, default: '#1e40af' },
    secondaryColor: { type: String, default: '#0f172a' },
    accentColor: { type: String, default: '#ca8a04' },
    titleText: { type: String, default: 'Certificate of Completion' },
    titleFontSize: { type: Number, default: 32 },
    titleColor: { type: String, default: '#1e40af' },
    bodyFontSize: { type: Number, default: 16 },
    bodyColor: { type: String, default: '#1e293b' },
    studentNameFontSize: { type: Number, default: 28 },
    studentNameColor: { type: String, default: '#0f172a' },
    borderColor: { type: String, default: '#ca8a04' },
    ...
    footerText: { type: String, default: 'This certificate can be verified online at our official website' },
  },
