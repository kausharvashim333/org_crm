                ...
                <div className="lg:col-span-7 flex flex-col items-center lg:items-start text-center lg:text-left space-y-4">
                  ...
                  <Reveal delay={100}>
                    <div className="space-y-1">
                      <h1 className="font-black tracking-tight leading-[1.65] text-3xl sm:text-4xl lg:text-5xl xl:text-6xl" style={{ color: hp.hero?.headingColor || '#0f172a', fontSize: ['number'].includes(typeof hp.hero?.headingFontSize) ? `${hp.hero.headingFontSize}px` : undefined }}>
                        {(() => {
