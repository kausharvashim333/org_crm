...
export function HeroEditor({ homepage, onSave }) {
  ...
  return (
    <div className="card space-y-4">
      ...
      <Field label="Heading 2 (optional, shown below main heading)"><input type="text" value={data.heading2 || ''} onChange={(e) => setData({ ...data, heading2: e.target.value })} className="input-field" placeholder="e.g. Admissions Open 2026-27" /></Field>
      <Field label="Heading 2 Text Color"><div className="flex items-center gap-2"><input type="color" value={data.heading2Color || '#4f46e5'} onChange={(e) => setData({ ...data, heading2Color: e.target.value })} className="w-12 h-10 rounded border border-slate-200 cursor-pointer" /><input type="text" value={data.heading2Color || '#4f46e5'} onChange={(e) => setData({ ...data, heading2Color: e.target.value })} className="input-field flex-1" /></div></Field>
