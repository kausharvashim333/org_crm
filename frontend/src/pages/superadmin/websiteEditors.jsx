...
export function HeroEditor({ homepage, onSave }) {
  ...
  return (
    <div className="card space-y-4">
      ...
      <Field label="Heading Line Spacing"><select value={data.headingLineHeight || '1.65'} onChange={(e) => setData({ ...data, headingLineHeight: parseFloat(e.target.value) })} className="input-field"><option value="1.1">Tight (1.1)</option><option value="1.3">Snug (1.3)</option><option value="1.5">Normal (1.5)</option><option value="1.65">Relaxed (1.65)</option><option value="1.8">Loose (1.8)</option><option value="2.0">Extra Loose (2.0)</option></select></Field>
