...
export const uploadOrgLogo = (formData) => API.post('/org-homepage/upload-logo', formData, { headers: { 'Content-Type': 'multipart/form-data' } });
export const uploadOrgFavicon = (formData) => API.post('/org-homepage/upload-favicon', formData, { headers: { 'Content-Type': 'multipart/form-data' } });
export const uploadOrgImage = (formData) => API.post('/org-homepage/upload-image', formData, { headers: { 'Content-Type': 'multipart/form-data' } });
export const uploadOrgPdf = (formData) => API.post('/org-homepage/upload-pdf', formData, { headers: { 'Content-Type': 'multipart/form-data' } });
